...
pub const DEFAULT_PACKAGE_README_LK_ESCAPED: &str =
    "one/two%20two/three%20three%20three/READ%20ME.md";
pub const DEFAULT_PACKAGE_README_PK: &str = "s3://data-yaml-spec-tests/reference/quilt-rs/one/two%20two/three%20three%20three/READ%20ME.md?versionId=aIOyttmoQaE2cMcwEEoRod5G_3TZEHAW";
pub const DEFAULT_PACKAGE_TIMESTAMP_LK: &str = "timestamp.txt";
pub const DEFAULT_PACKAGE_TIMESTAMP_PK: &str = "s3://data-yaml-spec-tests/reference/quilt-rs/timestamp.txt?versionId=by4o4I2atAvVQDq1wyOJuP7y2pAh8Gqx";
