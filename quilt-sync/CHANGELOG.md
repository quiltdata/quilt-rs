...
- On the new main page the buttons, drop-downs, search box and view switch now line up: they share one height, where before each was its own size and the toolbar read as a ragged row. Rows in **Needs your attention** and the top bar grew a few pixels to match (<https://github.com/quiltdata/quilt-rs/pull/912>)
